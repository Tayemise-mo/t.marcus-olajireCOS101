fn main() {
    ...
    // This means the slice starts from the index 0 and goes up to the index 3 (Exclusive)
    ...
    let slice4 = &numbers[..];
    //This means the slice starys from index 0 and goes up to the index 5 (Exclusive).
